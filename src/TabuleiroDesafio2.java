...
public class TabuleiroDesafio2 {
    public static void main(String[] args) {
        ...
        System.out.println("O robo Rover esta na posicao 10 da tabela. Ele  precisa andar ate a posicao 28 da tabela. De somente o comando que ele precise");
        ...
        if (posicao == acerto) {
            ...
            System.out.println("Voce errou a posicao " + posicao + " esta errada ele precisa chegar na posicao 28 do tabuleiro.");
        }
    }
