...
public class TabuleiroObstaculo2 {
    public static void main(String[] args) {
        ...
        if (posicao == acerto) {
            System.out.println("Parabens o rover chegou na casa 55!!!");
        } else if (posicao != acerto && !atingiuObstaculo) {
            System.out.println("A casa "+posicao+" esta errada. Voce precisa  chegar na casa 55!!!");
